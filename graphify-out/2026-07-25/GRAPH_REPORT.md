...
## Corpus Check
- 115 files · ~49,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1316 nodes · 3530 edges · 58 communities (44 shown, 14 thin omitted)
...
Cohesion: 0.06
Nodes (33): FakeDownloadTDLClient, FakeExportTDLClient, Path, ServiceTests, StateStoreTests, has_downloadable_media(), is_image_message(), Any (+25 more)
...
Cohesion: 0.07
Nodes (62): base_fingerprint(), base_manifest_is_current(), build_archive(), build_base_archive(), build_migration_archive(), is_excluded(), iter_files(), main() (+54 more)
...
Cohesion: 0.16
Nodes (9): Protocol, JobStoreTests, ActorResolver, JobRepository, Any, StorageDelivery, WorkerDispatcher, Job (+1 more)
...
- **Why does `AppConfig` connect `SerialPerKeyQueue` to `ProfileManager`, `SerialPerKeyQueue`, `ProfileTests`, `ExportResult`, `@radix-ui/react-dropdown-menu`, `StorageCatalog`, `ExportService`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `StorageCatalog` connect `StorageCatalog` to `ExportService`, `models.py`, `DownloadProgressTracker`, `BackupCoordinator`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `ProfileManager` connect `SerialPerKeyQueue` to `ProfileManager`, `TDLClient`, `ProfileTests`, `WorkerRegistry`, `SerialPerKeyQueue`, `@radix-ui/react-dropdown-menu`, `next`, `ExportService`, `dependencies`?**
