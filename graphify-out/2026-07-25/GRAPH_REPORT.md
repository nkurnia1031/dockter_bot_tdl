...
## Corpus Check
- 126 files · ~49,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1403 nodes · 3578 edges · 73 communities (47 shown, 26 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 365 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d979281c`
...
Cohesion: 0.17
Nodes (10): UtilitySettingsTests, BackupArchive, Create encrypted, runtime-only per-node backup archives., safe_node_name(), utc_now(), ValueError, UtilityPathError, UtilityResult (+2 more)
...
### Community 69 - "test_backup_service.py"
Cohesion: 0.53
...
- **Why does `AppConfig` connect `SerialPerKeyQueue` to `ProfileSelectionStore`, `test_backup_service.py`, `edit_menu_message`, `run.py`, `TDLClient`, `SourceState`, `DownloadProgressTracker`, `DomainError`, `telegram/app.py`?**
...
- **Why does `SqliteJobRepository` connect `organize_media_from_json.py` to `composition.py`, `ExportService`, `edit_menu_message`, `BackendApiTests`, `SqliteAuthRepository`, `DomainError`?**
