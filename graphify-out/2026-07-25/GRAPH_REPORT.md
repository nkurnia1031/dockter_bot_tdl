...
## Corpus Check
- 127 files · ~49,946 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1409 nodes · 3596 edges · 73 communities (48 shown, 25 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 369 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da2108fd`
...
Cohesion: 0.14
Nodes (10): UtilitySettingsTests, UtilitySummaryTests, Path, ValueError, UtilityFolderStore, UtilityPathError, UtilityResult, UtilityRunner (+2 more)
...
Cohesion: 0.07
Nodes (24): BackupServiceTests, make_config(), Path, item_values(), StorageCatalogTests, BackupArchive, BackupService, Path (+16 more)
...
Cohesion: 0.15
Nodes (8): build_backend_context(), ControlPlaneBackupRouter, _first_actor(), _NullCoordinator, JsonHttpError, WorkerHttpDispatcher, WorkerEventPublisher, Framework-independent worker execution adapter.
...
- **Why does `ProfileManager` connect `SerialPerKeyQueue` to `FakeProfiles`, `SerialPerKeyQueue`, `edit_menu_message`, `bot_text.py`, `TDLClient`, `SourceState`, `DownloadProgressTracker`, `DomainError`, `telegram/app.py`?**
