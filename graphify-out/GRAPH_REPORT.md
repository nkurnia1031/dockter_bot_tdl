...
## Corpus Check
- 148 files · ~96,707 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 9 file(s) not represented in the graph (top: (none) 6, .base 1, .conf 1)

## Summary
- 2163 nodes · 5199 edges · 102 communities (79 shown, 20 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 277 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e4b80c9`
...
Cohesion: 0.13
Nodes (18): LeaveResult, LeaveService, has_downloadable_media(), is_image_message(), Any, BatchDownloadResult, BatchDownloadService, DownloadedJsonResult (+10 more)
...
Cohesion: 0.05
Nodes (46): create_backend_app(), add_label(), archive_artifact(), browser_actor_dict(), browser_challenge(), browser_challenge_status(), browser_logout(), browser_profile() (+38 more)
...
### Community 36 - "backup_service.py"
Cohesion: 0.14
Nodes (10): BackupCoordinator, BackupNodeJob, datetime, Gateway orchestration, channel upload, scheduling, and retention., Worker-neutral command payload for one node backup., BackupArchive, Create encrypted, runtime-only per-node backup archives., safe_node_name() (+2 more)
...
Cohesion: 0.21
Nodes (7): Enum, JobStoreTests, Framework-independent domain model for the tme3bot control plane., JobEvent, JobStatus, datetime, utc_now()
...
Cohesion: 0.24
Nodes (6): StorageWorkerPathTests, Path, Return a safe, shallow directory listing for the active workspace., Return nested directories, including empty ones, as portable paths., storage_logical_folder(), storage_relative_folders()
...
### Community 93 - "Path"
Cohesion: 0.47
Nodes (4): Path, QuickThumbnailTests, fake_run(), fake_run()
...
### Community 97 - "WorkerEventPublisher"
Cohesion: 0.25
Nodes (4): json_value(), _utility_progress_message(), WorkerEventPublisher, utility_progress()

### Community 98 - "test_backup_service.py"
Cohesion: 0.60
Nodes (3): BackupServiceTests, make_config(), Path

### Community 100 - "utility_setting_specs"
Cohesion: 0.67
...
- **Why does `create_backend_app()` connect `create_backend_app` to `_error`, `utility_setting_specs`, `job_dict`, `JobEvent`, `StorageCatalog`, `composition.py`, `sign_storage_item`, `.setUp`, `ControlPlane`, `backend.py`, `storage_item_dict`, `test_backend_api.py`?**
...
- **Why does `StorageCatalog` connect `StorageCatalog` to `test_backup_service.py`, `backup_service.py`, `BackendApiTests`, `BackupService`, `composition.py`, `.setUp`, `test_backend_api.py`?**
