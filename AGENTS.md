...
- `tme3bot/app.py` adalah router Telegram dan lifecycle worker.
...
- `bot_workers.py` menangani export/download/leave; `utility_workers.py` menangani utility.
- `state.py` menyimpan `state.json`; `source_handler.py` menangani source dan label.
